...
private:
    ...
    public:
        ...
        uint8_t board_identify(int &firstPointRow, int &firstPointColumn, WinType &winType)
        {
...
public:
    ...
    uint8_t game(int &firstPointRow, int &firstPointColumn, WinType &winType)
    {
        uint8_t result = nodeRoot->board_identify(firstPointRow, firstPointColumn, winType);
...
public:
    void actionByHuman(int humanPosRow, int humanPosColumn);
    void actionByAI(int &machinePosRow, int &machinePosColumn);
    bool isWin(int &firstPointRow, int &firstPointColumn, uint8_t &result, WinType &winType);
    bool chessIsFull();
    void machine_human_play(int humanPosRow, int humanPosColumn);
    void AIPlay();
